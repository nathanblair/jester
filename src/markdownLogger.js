...
export class MarkdownLogger extends Logger {
  /** @typedef {Logger.LevelBitmask} Level */
  /** @typedef {Logger.ChannelBitmask} Channel */
...
`
  ...
  WriteTestFoot(id, status) {
    console.log(
      `### ${id} Summary (passed/total): ${status.totalAssertions -
