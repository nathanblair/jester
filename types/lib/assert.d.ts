 ...
 */
export function Assert(assertFunction: () => void, shouldMsg: string, status: import("./status.js").Status, testLogger?: import("./logger/testLogger.js").TestLogger | undefined, skip?: boolean): boolean;
