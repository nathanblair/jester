 ...
 * @param {import('./status').Status} status forwarded parameter from the `Run` method
 * @param {import('./logger').TestLogger} [testLogger] forwarded parameter from the `Run` method
 *
 * @example
 * const dummy = 2
