...
/**
  ...
  *
  * @example
  * // Execute below with `npx jester [experimental-flags]`
  *
  * // test/jestertest.js
  ...
  *     Test.Assert(() => assert.strictEqual(2, 2), '2 should equal 2', status, logger)
  *
  *     Test.Assert(() => assert.throws(() => new Test()), 'Should not be able to instantiate a new Test instance', status, logger)
  *   }
  * }
  *
  * @abstract
...
export class Test {
  ...
  /**
    ...
    * @protected
    */
  static Assert(assertFunction, shouldMsg, status, testLogger = undefined) {
